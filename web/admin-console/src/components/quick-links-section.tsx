    ...
    <section className="space-y-3">
      <div>
        ...
        <p className="text-sm text-muted-foreground">
          Shortcuts to support and collaboration systems, and one-click connections in your browser.
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <p className="text-sm text-muted-foreground">No quick links match “{search}”.</p>
      ) : (
