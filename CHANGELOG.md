...
- **A security baseline for the independent review (#959).** An OpenSSF
  ...
  result that the new README badge shows. `docs/security/asvs-l2.md` is the
  project's own OWASP ASVS 4.0.3 Level 2 assessment; gaps that are
  vulnerabilities are reported privately under SECURITY.md.
  `docs/security/pentest-scope.md` is the scope to send to penetration-test
