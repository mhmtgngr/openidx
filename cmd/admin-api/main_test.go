// Package main provides tests for the Admin API entry point
package main
...
// TestAdminAPI_ConfigValidation tests configuration validation scenarios
func TestAdminAPI_ConfigValidation(t *testing.T) {
	...
	t.Run("Invalid port returns error", func(t *testing.T) {
		...
		_, err := config.Load("admin-api")
		assert.Error(t, err)
		assert.Contains(t, err.Error(), "port")
	})
}

// TestAdminAPI_ProductionConfigValidation tests production-specific validation
func TestAdminAPI_ProductionConfigValidation(t *testing.T) {
	tests := []struct {
		name        string
		cfg         *config.Config
		wantErr     bool
...
// TestAdminAPI_HealthEndpoints tests health check endpoint registration
...
// TestAdminAPI_RouteRegistration tests that admin API routes are registered
func TestAdminAPI_RouteRegistration(t *testing.T) {
	t.Run("Admin API registers expected routes", func(t *testing.T) {
		router := gin.New()
		log := zap.NewNop()
...
// TestAdminAPI_GracefulShutdown tests graceful shutdown behavior
func TestAdminAPI_GracefulShutdown(t *testing.T) {
...
// TestAdminAPI_ErrorHandling tests error handling scenarios
func TestAdminAPI_ErrorHandling(t *testing.T) {
...
// TestAdminAPI_MiddlewareConfiguration tests middleware setup
func TestAdminAPI_MiddlewareConfiguration(t *testing.T) {
...
// TestAdminAPI_AdapterInterfaces tests the adapter types
func TestAdminAPI_AdapterInterfaces(t *testing.T) {
	t.Run("Directory sync adapter implements required methods", func(t *testing.T) {
	...
	t.Run("Risk service adapter implements required methods", func(t *testing.T) {
		adapter := &riskServiceAdapter{}
		assert.NotNil(t, adapter)
	})

	t.Run("API key adapter implements required methods", func(t *testing.T) {
		adapter := &apiKeyAdapter{}
		assert.NotNil(t, adapter)
	})

	t.Run("Webhook adapter implements required methods", func(t *testing.T) {
		adapter := &webhookAdapter{}
		assert.NotNil(t, adapter)
	})

	t.Run("Security adapter implements required methods", func(t *testing.T) {
		adapter := &securityAdapter{}
		assert.NotNil(t, adapter)
	})
}

// TestAdminAPI_CORSConfiguration tests CORS configuration
func TestAdminAPI_CORSConfiguration(t *testing.T) {
	tests := []struct {
		name         string
		origins      string
		expectOrigin []string
	}{
		{"Wildcard CORS", "*", []string{"*"}},
...
// TestAdminAPI_ProductionWarnings tests production warning generation
func TestAdminAPI_ProductionWarnings(t *testing.T) {
...
func BenchmarkAdminAPI_HealthCheck(b *testing.B) {
	router := gin.New()
	log := zap.NewNop()
	healthService := health.NewHealthService(log)
	healthService.SetVersion("test-version")
