...
func main() {
	...
	metrics.NewTracedPool(db.Pool.Raw(), "governance-service").StartPoolStatsCollector(context.Background())
	...
	// Body cap (policy and review payloads are small JSON); oversize is 413 before any handler runs (task 0.3).
