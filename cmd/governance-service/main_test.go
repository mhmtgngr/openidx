// Package main provides tests for the Governance Service entry point
package main
...
// TestGovernanceService_ConfigValidation tests configuration validation scenarios
func TestGovernanceService_ConfigValidation(t *testing.T) {
	...
	t.Run("Invalid port returns error", func(t *testing.T) {
		...
		_, err := config.Load("governance-service")
		assert.Error(t, err)
		assert.Contains(t, err.Error(), "port")
	})
}

// TestGovernanceService_ProductionConfigValidation tests production-specific validation
func TestGovernanceService_ProductionConfigValidation(t *testing.T) {
	tests := []struct {
		name        string
		cfg         *config.Config
		wantErr     bool
...
// TestGovernanceService_HealthEndpoints tests health check endpoint registration
func TestGovernanceService_HealthEndpoints(t *testing.T) {
...
// TestGovernanceService_RouteRegistration tests that governance service routes are registered
func TestGovernanceService_RouteRegistration(t *testing.T) {
	t.Run("Governance service registers expected routes", func(t *testing.T) {
		router := gin.New()
		log := zap.NewNop()
...
// TestGovernanceService_GracefulShutdown tests graceful shutdown behavior
func TestGovernanceService_GracefulShutdown(t *testing.T) {
...
// TestGovernanceService_ErrorHandling tests error handling scenarios
func TestGovernanceService_ErrorHandling(t *testing.T) {
...
// TestGovernanceService_MiddlewareConfiguration tests middleware setup
func TestGovernanceService_MiddlewareConfiguration(t *testing.T) {
...
// TestGovernanceService_OPAConfiguration tests OPA authorization configuration
func TestGovernanceService_OPAConfiguration(t *testing.T) {
	tests := []struct {
		name         string
		opaEnabled   bool
		opaURL       string
...
// TestGovernanceService_BackgroundWorkers tests background worker configuration
func TestGovernanceService_BackgroundWorkers(t *testing.T) {
	t.Run("Background workers can be configured", func(t *testing.T) {
		// Governance service starts background workers for:
		// - JIT expiration checker
		// - Campaign scheduler
		// We test that the context cancellation works correctly
...
// TestGovernanceService_AccessReviewsConfiguration tests access review configuration
func TestGovernanceService_AccessReviewsConfiguration(t *testing.T) {
...
// TestGovernanceService_ProductionWarnings tests production warning generation
func TestGovernanceService_ProductionWarnings(t *testing.T) {
...
func BenchmarkGovernanceService_HealthCheck(b *testing.B) {
	router := gin.New()
	log := zap.NewNop()
	healthService := health.NewHealthService(log)
	healthService.SetVersion("test-version")
